          ...
          <div className="grid grid-cols-1 gap-4 h-full">
            ...
            <div className="relative">
              <div className="aspect-video bg-gray-800 rounded-lg overflow-hidden">
                <VideoPlayer stream={localStream} isLocal={true} className="w-full h-full" muted={isMuted} />
              </div>
              <div className="absolute top-2 left-2 bg-black bg-opacity-50 px-2 py-1 rounded text-xs">You</div>
            </div>
            ...
            <div className="relative">
              <div className="aspect-video bg-gray-800 rounded-lg overflow-hidden">
                <VideoPlayer
                  ...
                  status={
                    isConnected ? 'connected' : isWaiting ? 'waiting' : isDisconnected ? 'disconnected' : 'no-one'
                  }
                />
              </div>
          ...
          <div className="mb-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="relative">
                ...
                <div className="absolute top-2 left-2 bg-black bg-opacity-50 px-2 py-1 rounded text-sm">You</div>
              </div>
